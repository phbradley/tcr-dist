...
scipy:
				https://www.scipy.org/install.html ## this website was dead but it looks temporary
...
convert:
				...
				if you have an alternative you can modify the function "convert_png_to_svg" in basic.py
...
For an overview of what the analysis is supposed to do, consult the publication listed below in the "CITING"
section.
...
where <organism> is either mouse or human, and <filename> is the name of a .tsv (tab-separated values) file
